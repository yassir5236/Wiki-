...
<div class="card bg-gray-100 mt-5 p-5">
    ...
    <form action="<?php echo URLROOT; ?>/Tags/add" method="post">
        <div class="mb-4">
            ...
            <input type="text" name="tag_name" class="w-full p-2 border rounded <?php echo (!empty($data['title_err'])) ? 'border-red-500' : 'border-gray-300'; ?>" value="<?php echo $data['tag_name']; ?>">
